...
Bu program e-Fatura, PDF, MAHSUP fişi (fiş listesi) ve Excel faturalarınızı KDV kontrol cetveli ile karşılaştırır. 
...
\- 💡 Satış muavininizi de (ör. \*\*muavin_gokkusagi.xlsx\*\*) seçerseniz MAHSUP fişindeki hesap kayıtları otomatik olarak muavinle karşılaştırılır
