...
def vkn_uyumlu(f: dict[str, Any], c: dict[str, Any]) -> bool:
    f_vkn: str = f.get("satici_vkn") or ""
    c_vkn: str = c.get("vkn") or ""
    if not f_vkn or not c_vkn:
        return True
    return f_vkn == c_vkn


def tutarlar_uyumlu(f: dict[str, Any], c: dict[str, Any]) -> bool:
